    ...
    <div class="flex justify-center h-full">
      <div class="bg-primary w-96 shadow dark:border bg-cover rounded px-8 pt-8 pb-8 ">
        ...
        <form @submit.prevent="authStore.handleLogin">
          ...
          <div>
            <label>
              <span class="mb-2 pr-64 after:content-['*'] after:ml-0.5 after:text-red-500 block text-sm font-medium text-color">
                Email
              </span>
          ...
          <div>
            <label>
              <span class="mb-2 pr-56 after:content-['*'] after:ml-0.5 after:text-red-500 block text-sm font-medium text-color">
                Password
              </span>
              <input type="password" name="password" v-model="authStore.form.password" class="input-text w-full max-w-xs mt-1 
