<template>
  <div class="drawer bg-blue-900 z-10">
    <input id="my-drawer" type="checkbox" class="drawer-toggle" />
    <div class="drawer-content flex">
      <!-- Page content here -->
      <label for="my-drawer" class="w-9">
        <svg class="cursor-pointer m-1" width="38px" height="38px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g id="Menu / Menu_Alt_05"> <path id="Vector" d="M5 17H13M5 12H19M11 7H19" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g> </g></svg>
      </label>
    ...
    <div class="drawer-side">
      ...
      >
        ...
        <h5
          class="text-left mb-3 font-semibold text-white uppercase dark:text-gray-400"
        >
          Menu
        </h5>
